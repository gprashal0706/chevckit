...
test_that("cross validation works", {
  ...
  expect_equal(dts[cv_folds[[1]][["test"]]],
               ymd("2019-10-07") + minutes(1)*0:(1441*2-1))
  expect_equal(dts[cv_folds[[2]][["train"]]],
               ymd("2019-10-01") + minutes(1)*0:(1441*7-1))
  expect_equal(dts[cv_folds[[2]][["test"]]],
               ymd("2019-10-08") + minutes(1)*0:(1441*2-1))
  expect_equal(dts[cv_folds[[3]][["train"]]],
               ymd("2019-10-01") + minutes(1)*0:(1441*8-1))
  ...
  expect_equal(dts[cv_folds[[2]][["test"]]],
               ymd("2019-10-09") + minutes(1)*0:(1441*2-1))
  expect_equal(dts[cv_folds[[3]][["train"]]],
               ymd("2019-10-01") + minutes(1)*0:(1441*10-1))
  expect_equal(dts[cv_folds[[3]][["test"]]],
               ymd("2019-10-11") + minutes(1)*0:(1441*2-1))
})
